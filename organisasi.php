...
<head>
    ...
    <title>Organisasi | SMKN 4 TASIKMALAYA</title>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card text-center" style="border-radius: 20px;">
                    <div class="card-body">
                        <img src="galeri/mpk.CJQoldjo.png" style="width: 200px; height: 200px; " alt="">
                        <p>
                        <h5>MPK</h5>
                        </p>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card text-center" style="border-radius: 20px;">
                    <div class="card-body">
                        <img src="galeri/pub.C7gcMgJy.png" style="width: 200px; height: 200px; " alt="">
                        <p>
                        <h5>PUB</h5>
                        </p>
                    </div>
