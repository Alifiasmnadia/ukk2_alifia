...
<body>
    ...
    <section class="pt-4 mt-4">
        ...
        <!-- section statistik -->
        <section id="sambutan" class="p-5 bg-white text-center">
            <div class="container ">
                <h2 class="fw-bold text-primary ">Data Statistik Sekolah</h2>
                <hr class="mx-auto garis-judul mb-5">
                <div class="row justify-content-center">
                    <div class="col-6 col-md-2 mb-4">
                        <div class="stat-card p-3 rounded-4 shadow-sm bg-white">
                            <i class="bi bi-people-fill fs-1 text-primary mb-2"></i>
                            <h3 class="fw-bold text-dark"><span class="counter" data-target="1500">0</span>+</h3>
                    ...
                    <div class="col-6 col-md-2 mb-4">
                        <div class="stat-card p-3 rounded-4 shadow-sm bg-white">
                            ...
                            <h3 class="fw-bold text-dark"><span class="counter" data-target="82">0</span></h3>
                            <p class="mb-0 text-secondary">Tenaga Pendidik</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-2 mb-4">
                        <div class="stat-card p-3 rounded-4 shadow-sm bg-white">
                            <i class="bi bi-person-badge-fill fs-1 text-primary mb-2"></i>
                            <h3 class="fw-bold text-dark"><span class="counter" data-target="10">0</span></h3>
                            <p class="mb-0 text-secondary">Tenaga TU</p>
                        </div>
                    </div>
                    <div class="col-6 col-md-2 mb-4">
                        <div class="stat-card p-3 rounded-4 shadow-sm bg-white">
                            <i class="bi bi-trophy-fill fs-1 text-primary mb-2"></i>
                            <h3 class="fw-bold text-dark"><span class="counter" data-target="17">0</span></h3>
                            <p class="mb-0 text-secondary">Ekstrakulikuler</p>
                        </div>
                    </div>
                </div>
            </div>
